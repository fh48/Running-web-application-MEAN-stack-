/** @module compareTo **/
angular.module('hfApp.uploadGpxArea', []).directive('hfUploadGpxArea', function(ApiService, Notification) {
	return {
		scope: {
		...
		replace: true,
		transclude: true,
		templateUrl: "app/components/uploadGpx/upload-gpx-area.html",
